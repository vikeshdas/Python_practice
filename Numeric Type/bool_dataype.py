"""
- In python bool is subclass of int ,means bool class inherit int class
-By default, an object is  true. if a class defines  a __bool__() method that returns False 
- or a __len__() method that returns zero in these two case object will be Fasle otherwise By default it will  be True.

-Tru and False are singletun object, They will always return retain their same memory address through out the life time of your application 

-To compare two bool value you can use either (is) operation or == operator,"is" compare memory address and "==" compare state(value)
"""
